"""
Process measurement images using EasyOCR (alternative to PaddleOCR)
"""
import os
import sys
...
print("="*80)
print("PROCESSING MEASUREMENT & PPT IMAGES WITH EASYOCR")
print("="*80)
print()
...
for r in results:
    print(f"{r['image']}: {len(r['dimensions'])} dimensions")
